...
Defines the key mappings that hold with no plugin installed — how windows are focused, resized, split and maximized, how buffers are switched, created and deleted, how a search highlight is dismissed, how a buffer is saved, how a visual selection survives an indent, how a line is terminated with a semicolon, and how the editor is restarted.
## Requirements
