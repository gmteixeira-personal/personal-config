# Generated by tide-save-config -- do not edit by hand.
# Mirrors the tide_* universal variables as globals so git carries the
# prompt config; fish_variables itself stays gitignored. After running
# 'tide configure', run tide-save-config again to refresh this file.
...
set -g tide_right_prompt_items status cmd_duration context jobs bun node python rustc java php pulumi ruby go gcloud kubectl distrobox toolbox terraform aws nix_shell crystal elixir zig time
