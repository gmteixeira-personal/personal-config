...
Each command SHALL end with a short report of the actions it performed and the resulting repository state, and SHALL surface git's own error output when it stops.
