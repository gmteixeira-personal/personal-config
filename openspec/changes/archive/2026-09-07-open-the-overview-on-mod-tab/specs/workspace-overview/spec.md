...
- **WHEN** the chord that opened the Overview before this capability existed is pressed
- **THEN** the Overview SHALL open and close exactly as it did
