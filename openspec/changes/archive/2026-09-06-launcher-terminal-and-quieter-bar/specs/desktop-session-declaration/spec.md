...
#### Scenario: The documentation does not claim a tracked file is absent

- **WHEN** the repository tracks a configuration file for a session program
- **THEN** the documentation SHALL NOT describe that program as running on its built-in defaults
